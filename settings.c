...
void SETTINGS_InitEEPROM(void) {
  uint8_t Data[16] = {0};
  // 0E60..0E67
  // leocatto.com: UHFCB MOD Settings
  EEPROM_ReadBuffer(0x0E60, Data, 8);
  gEeprom.UHFCB_CHANNEL = Data[0];
  gEeprom.UHFCB_USE_REPEATER = Data[1];
  // ... rest unused (6B)

  // 0E68..0E6F
  // leocatto.com: RESERVED
...
void SETTINGS_SaveSettings(void) {
  ...
  // 0E60..0E67
  // leocatto.com: UHFCB MOD Settings
  State[0] = gEeprom.UHFCB_CHANNEL;
  State[1] = gEeprom.UHFCB_USE_REPEATER;
  // ... rest unused (6B)
  EEPROM_WriteBuffer(0x0E60, State);
